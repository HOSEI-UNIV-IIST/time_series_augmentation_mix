...
def run_augmentation(x, y, args):
    ...
    if args.augmentation_ratio > 0:
        ...
        for n in range(args.augmentation_ratio):
            ...
            elif 'sequential_magnitude' in args.augmentation_method:
                method_num = args.augmentation_method[-1]
                x_temp, y_temp, temp_tags = globals()[f'augment_data_sequential_magnitude{method_num}'](x, y)
            elif 'sequential_time' in args.augmentation_method:
                method_num = args.augmentation_method[-1]
                x_temp, y_temp, temp_tags = globals()[f'augment_data_sequential_time{method_num}'](x, y)
            elif 'sequential_combined' in args.augmentation_method:
                method_num = args.augmentation_method[-1]
                x_temp, y_temp, temp_tags = globals()[f'augment_data_sequential_combined{method_num}'](x, y)
